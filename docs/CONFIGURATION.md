...
```text
lmrelay: [server] rate_limit was replaced by [limits.per_token] rate,
[limits.per_address] rate, [limits.total] rate. Pick the scope you meant; see
